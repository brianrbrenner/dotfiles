...
mapper("n", "<S-l>", ":bn<CR>") -- next buffer
mapper("n", "<S-h>", ":bp<CR>") -- prev buffer
...
mapper("n", "<C-n>", ":NvimTreeToggle<CR>") -- toggle file browser in left split
...
mapper("n", "<Leader>ft", telescope_builtin.live_grep) -- search all lines in project
