 ...
 * |LCTRL|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   [  |   ]  |   /  |  ~    |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | CAPS | LALT| LGUI | /Space(LOWER)/     \Enter \  |BACK | -   | =    |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_COMMA,  KC_DOT,  KC_N,    KC_M,    KC_LEFT_BRACKET, KC_RIGHT_BRACKET,  KC_SLSH,  KC_GRAVE, 
  KC_CAPS_LOCK, KC_LEFT_ALT, KC_LGUI, LT(_LOWER, KC_SPC),   KC_ENT,   KC_BACKSPACE,  KC_MINUS, KC_EQUAL
  ),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |   _  |   +  |   {  |   }  |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Back \  |MPLAY |MPREV| MNEXT |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
                             _______, _______, _______, _______, KC_BACKSPACE,  KC_MPLY, KC_MPRV, KC_MNXT
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
